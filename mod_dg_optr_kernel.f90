...
module mod_dg_optr_kernel
  ...
  integer, parameter :: DGOPTR_EVALTYPEID_TENSORPROD3D_GENERAL  = 1 !< ID of the general tensor-product evaluation type for arbitrary p.
  integer, parameter :: DGOPTR_EVALTYPEID_TENSORPROD3D_OPT1     = 2 !< ID of the optimized tensor-product evaluation type. It uses codes explicitly generated by each p (=1~15). 
...
!OCL SERIAL
  subroutine tensorprod_divlike_dirXYZ( &
    ...
    if ( eval_typeid == DGOPTR_EVALTYPEID_TENSORPROD3D_GENERAL ) then
      ...
      select case(Nq-1)
      case(1)
        call element_operation_kernel_matvec_divlike_dirXYZ_P1( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(2)
        call element_operation_kernel_matvec_divlike_dirXYZ_P2( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(3)
        call element_operation_kernel_matvec_divlike_dirXYZ_P3( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(4)
        call element_operation_kernel_matvec_divlike_dirXYZ_P4( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(5)
        call element_operation_kernel_matvec_divlike_dirXYZ_P5( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(6)
        call element_operation_kernel_matvec_divlike_dirXYZ_P6( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(7)
        call element_operation_kernel_matvec_divlike_dirXYZ_P7( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(8)
        call element_operation_kernel_matvec_divlike_dirXYZ_P8( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(9)
        call element_operation_kernel_matvec_divlike_dirXYZ_P9( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(10)
        call element_operation_kernel_matvec_divlike_dirXYZ_P10( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(11)
        call element_operation_kernel_matvec_divlike_dirXYZ_P11( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(12)
        call element_operation_kernel_matvec_divlike_dirXYZ_P12( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(13)
        call element_operation_kernel_matvec_divlike_dirXYZ_P13( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(14)
        call element_operation_kernel_matvec_divlike_dirXYZ_P14( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      case(15)
        call element_operation_kernel_matvec_divlike_dirXYZ_P15( Mat, Mat_tr, vec_in_x, vec_in_y, vec_in_z, vec_out_x, vec_out_y, vec_out_z )
      end select
    end if
    return
